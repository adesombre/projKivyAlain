...
class CanvasExemple4(Widget):
	def __init__(self, **kwargs):
		super(CanvasExemple4, self).__init__(**kwargs)
		with self.canvas:
			Line(points=(100, 100, 400, 500), width=3)
			Color(0, 1, 0)
			Line(circle=(400, 200, 80), width=3)
			Line(rectangle= (500, 500, 150, 100), width=3)
			self.rect = Rectangle(pos=(dp(400), dp(200)), size=(dp(150), dp(100)))
...
class CanvasExemple5(Widget):
	def __init__(self, **kwargs):
		super(CanvasExemple5, self).__init__(**kwargs)
